...
description: Use ONLY when the user explicitly mentions the Sleek design tool (sleek.design), asks to connect to Sleek, or references existing Sleek projects and Sleek component codes. For general mobile UI/UX design, use design-taste-mobile instead.
